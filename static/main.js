...
jQuery(document).ready(function($) {
    ...
    if ($(this).hasClass("table-primary")) {
        ...
        $("#edit").removeData();
        $("#delete").removeData();
        $("#viewDetails").removeData();
        $("#viewUserDetails").removeData();
        $("#edit").attr("disabled", true);
        $("#delete").attr("disabled", true);
        $("#viewDetails").attr("disabled", true)
        $("#viewUserDetails").attr("disabled", true)
    } else {
        $(this).addClass("table-primary");
        $(".clickable-row").not($(this)).removeClass('table-primary');
        $("#edit").data("id", $(this).data("id"));
        $("#delete").data("id", $(this).data("id"));
        $("#viewDetails").data("id", $(this).data("id"))
        $("#viewUserDetails").data("id", $(this).data("id"))
        $("#viewDetails").data("book", $(this).data("book"))
        $("#viewUserDetails").data("user", $(this).data("user"))
        $("#edit").attr("disabled", false);
        $("#delete").attr("disabled", false );
        $("#viewDetails").attr("disabled", false);
        $("#viewUserDetails").attr("disabled", false);
}
    });
    ...
    // View modal buttons
    $("#viewBookCancelButton").click(function(event) {
        var id = $(this).data("id")
    ...
    $("#viewUserCancelButton").click(function(event) {
        var id = $(this).data("id")
        $(".clickable-row").removeClass('table-primary');
